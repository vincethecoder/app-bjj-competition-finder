...
final class RemoteCompetitionListLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWith: .failure(RemoteCompetitionListLoader.Error.connectivity), when: {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWith: .failure(RemoteCompetitionListLoader.Error.invalidData), when: {
